...
<div style="text-align:center; color:grey"><i><span style="color:#d32f2f;![alt text](image.png)">Figure 8-5</span> Straight Line Diagram Example</i></div>
</div>
</div>
...
<div style="text-align:center; color:grey"><i><span style="color:#d32f2f;![alt text](image.png)">Figure 8-6</span> Future Year Model Volumes from CFRPM 7.0 Example</i></div>
</div>
</div>
...
<div style="text-align:center; color:grey"><i><span style="color:#d32f2f;![alt text](image.png)">Figure 8-7</span> Linear Growth Option Example</i></div>
<center>
<img src="images/fig8_8.png" style="max-width: 80%; text-align:center; margin-bottom: 1rem">
</center>
<div style="text-align:center; color:grey"><i><span style="color:#d32f2f;![alt text](image.png)">Figure 8-8</span> Exponential Growth Option Example</i></div>
<center>
<img src="images/fig8_9.png" style="max-width: 80%; text-align:center; margin-bottom: 1rem">
</center>
<div style="text-align:center; color:grey"><i><span style="color:#d32f2f;![alt text](image.png)">Figure 8-9</span> Decaying Exponential Growth Option Example</i></div>
...
<div style="text-align:center; color:grey"><i><span style="color:#d32f2f;![alt text](image.png)">Figure 8-10 </span>Project Future Year AADT Volumes</i></div>
</div>
</div>
...
<div class="parent">
  ...
  <div style="text-align:center; color:grey"><i><span style="color:#d32f2f;![alt text](image.png)">Figure 8-11 </span>ESAL Tool Main Menu</i></div>
  <div style="color:#d32f2f; font-weight:bold; text-align:left">Example:</div>
  <ol>
  <li>
  ...
  <div style="text-align:center; color:grey"><i><span style="color:#d32f2f;![alt text](image.png)">Figure 8-12 </span>ESAL Tool Project Information Input Screen</i></div>
  ...
  <div style="text-align:center; color:grey"><i><span style="color:#d32f2f;![alt text](image.png)">Figure 8-13 </span>ESAL Tool Segment Information Input Screen</i></div>
...
<div class="parent">
    ...
    <div style="text-align:center; color:grey"><i><span style="color:#d32f2f;![alt text](image.png)">Figure 8-14 </span>18-KIP ESAL Report Printout</i></div>
