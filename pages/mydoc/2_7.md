...
<span class="subtitle-3">2.7.1	Seasonal Factor Category Report</span>
...
<div class="italic-grey"><span style ="color:red;">Figure 2-7</span> Volume Factor Categories for Hillsborough County</div>

<center><img src="images/fig2_8.png" style="max-width: 100%; text-align:center; margin-bottom: 1rem"></center>
<div class="italic-grey"><span style ="color:red;">Figure 2-8</span> Peak Season Factor Category Report for Hillsborough Countywide</div>


<span class="subtitle-3">2.7.2 Axle Factor Category Report</span>
...
<div class="italic-grey"><span style ="color:red;">Figure 2-9</span> Axle Correction Factors for Hillsborough County</div>

<span class="subtitle-3">2.7.3 Example of Estimating AADT from Short-Term Traffic Counts</span>
...
<ul><i>Short-term traffic counts should be reviewed for reasonableness and consistency
...
<div class="parent">
    ...
    <ul>
    <li style="margin:0; margin-top:1rem">Category: 8900 EAST- A1A TO US 1</li>
    <li style="margin:0.1em">Category: 8901 CEN.-W OF US 1 TO I-95</li>
...
<div class="italic-grey"><span style ="color:red;">Figure 2-10</span> Sample Short-Term Traffic Counts</div>

<center><img src="images/fig2_11.png" style="max-width: 80%; text-align:center; margin-bottom: 1rem"></center>
<div class="italic-grey"><span style ="color:red;">Figure 2-11</span> 2022 Peak Season Factor Category Report for Category 8901</div>
...
<div class="italic-grey"><span style ="color:red;">Figure 2-12</span> Weekly Axle Factory Category Report for Category 8909</div>
</div>
</div>
