...
<div class="parent">
    ...
    <div class="child2">
    <div style="color:#20a3d3; font-weight:bold;margin-bottom:1rem">Assign a Seasonal Factor from the Peak Season Factor Category Report</div>There are four volume factor categories for Martin County, three for the different geographic areas of the county, and one for I-95:
    <ul>
