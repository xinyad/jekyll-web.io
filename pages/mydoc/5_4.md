...
<li>Balance adjusted daily turning movement volumes to achieve directional symmetry. A simple way to do this is to sum the opposing traffic movements and divided by two. There may be some situations when balancing the intersection may not be appropriate. See Chapter 7 for a more detailed discussion about estimating intersection turning movements.</li>
