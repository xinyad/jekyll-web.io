...
<center>$$Volume_{FY}=Volume_{BY}\times{(1+(FY-BY))\times{G_{Linear}}}$$</center>
...
<center>$$Volume_{FY}=Volume_{BY}\times(1+G_r)^{(FY-BY)}$$</center>
...
<center>$$Volume_{FY}=Volume_{BY}\times{\sum^{FY}_{BY}\frac{X}{FY-BY}}{\sum^{FY}_{BY}\frac{X}{FY-BY}}$$</center>
